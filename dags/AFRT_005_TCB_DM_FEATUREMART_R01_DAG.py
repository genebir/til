...
with DAG(
    ...
    dag_id='AFRT_005_TCB_DM_FEATUREMART_R01_DAG',
    description='처리계DB_FEATURE마트데이터적재스케줄링(실시간)',
    # schedule='30 04 20 * *',
    schedule='@once',
    ...
    #     # CB마트 작업 대기
    #     task_id='S.AFRT_TCB_DM_CBMART_R01_DAG',
    #     external_dag_id='AFRT_TCB_DM_CBMART_R01_DAG',
    ...
    start >> key_proc >> procedure_ft_group >> jobId_End >> jobId_Next >> end
