...
with DAG(
    ...
    dag_id='AFMC_004_TCB_DM_CBMART_M01_DAG',
    description='처리계DB_CB마트데이터적재스케줄링',
    # schedule='30 21 * * *',
    schedule='@once',
    tags=['procedure', 'cb', 'monthly', 'batch'],
    catchup=False,
) as dag:
    ...
    sensor = ExternalTaskSensor(
        task_id='S.AFMC_003_TCB_DI_TDCI_TDDI_M01_DAG',
        external_dag_id='AFMC_003_TCB_DI_TDCI_TDDI_M01_DAG',
    ...
    with TaskGroup(group_id='PROCEDURE_GROUP') as procedure_dm_group :
        procedures = [
            {
                'schema':  'TCB_DM_DB',
    ...
    #pmc_dm_svc_cont_hst_1
    # pmc_dm_svc_cont_hst_1 = ProcedureOperator(
    #     task_id='T.PEC_DM_SVC_CONT_HST_1',
    #     schema='tcb_dm_db',
    #     procedure_name='pec_dm_svc_cont_hst_1',
    #     parameter=(base_ym,colec_path_itg_cd)
    # )

    # with TaskGroup(group_id='PROCEDURE_DLINQ_GROUP') as procedure_dlinq_group:
    #     procedures = [
    #         {
    #             'schema':  'TCB_DM_DB',
    #             'procedure_name': 'PEC_DM_DLINQ_HST_1',
    ...
    start >> sensor >> procedure_dm_group >> jobId_End >> jobId_Next >> end
    # sensor >> pmc_dm_svc_cont_hst_1 >> procedure_dlinq_group  >> jobId_End >> jobId_Next >> end