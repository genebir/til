...
with DAG(
        dag_id=f'AFOD_008_OPT_IF_CBMART_O01_DAG',
        description='운영계DB_온디멘드데이터적재_스케줄링',
    ...
    sensor = ExternalTaskSensor(
        task_id = 'W.AFOD_007_TCB_DT_CBMART_M01_DAG',
        external_dag_id = 'AFOD_TCB_DT_CBMART_M01_DAG',
        ...
        for i in df.index[12:]:
            ...
            GlueJobOperator(task_id=f'T.{job_name}',
                            ...
                            script_args={
                                ...
                                '--BASE_YM': base_ym,
                                '--JOB': df['JOB'][i],
                                '--COLEC_PATH': colecPathItgCd, # 수집경로통합코드 : ondemand
                                '--S3_BUCKET_NM': bucketNm,
                                '--JOBID' : job_id,
                                '--SEC_MANAGER_ID' : optSecManageId
                            },
    ...
    start_dag >> sensor >> glue_job_1 >> jobId_End >> procedure_custIdfy >> procedure_cbgroup1 >> procedure_feature >> procedure_cbgroup2 >> end_dag
    start_dag >> sensor >> glue_job_2 >> jobId_End >> procedure_custIdfy >> procedure_cbgroup1 >> procedure_feature >> procedure_cbgroup2 >> end_dag
