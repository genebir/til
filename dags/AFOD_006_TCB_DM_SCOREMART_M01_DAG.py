...
base_ym        = '202106'
# base_ym           = get_base_ym()
colecPathItgCd = '10003'  # 정기배치: 10001, 온라인 : 10002, 온디맨드 : 10003
########################################################################################################################
...
with DAG(
    ...
    dag_id='AFOD_006_TCB_DM_SCOREMART_M01_DAG',
    description='처리계DB_SCORE마트데이터적재스케줄링(OnDemand)',
    # schedule='30 04 20 * *',
    schedule='@once',
    ...
    sensor = ExternalTaskSensor(
        # CB마트 작업 대기
        task_id='S.AFOD_TCB_DM_FEATUREMART_M01_DAG',
        external_dag_id='AFOD_TCB_DM_FEATUREMART_M01_DAG',
