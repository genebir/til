...
with DAG(
    ...
    dag_id='AFMC_003_TCB_DI_TDCI_TDDI_M01_DAG',
    ...
    sensor = ExternalTaskSensor(
                task_id=f'S.AFMC_002_TCB_CI_TDDC_TDCI_M01_DAG',
                external_dag_id=f'AFMC_002_TCB_CI_TDDC_TDCI_M01_DAG',
