...
with DAG(
        dag_id=f'AFMC_007_TCB_DT_CBMART_M01_DAG',
        description='운영계DB_마트데이터제공(S3저장)스케줄링(정기)',
    ...
    # jobId = 'IM_2023100510001100000040'
    ...
    sensor = ExternalTaskSensor(
        task_id = 'W.AFMC_006_TCB_DM_SCOREMART_M01_DAG',
        external_dag_id = 'AFMC_006_TCB_DM_SCOREMART_M01_DAG',
