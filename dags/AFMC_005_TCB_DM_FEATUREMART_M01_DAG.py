...
with DAG(
    ...
    dag_id='AFMC_005_TCB_DM_FEATUREMART_M01_DAG',
    description='처리계DB_FEATURE마트데이터적재스케줄링',
    # schedule='0 22 * * *',
    schedule='@once',
    ...
    sensor = ExternalTaskSensor(
        # CB마트 작업 대기
        task_id='S.AFMC_004_TCB_DM_CBMART_M01_DAG',
        external_dag_id='AFMC_004_TCB_DM_CBMART_M01_DAG',
